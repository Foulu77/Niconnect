  ...
  return (
    <Gutter className={classes.orders}>
      ...
      <div className={classes.itemMeta}>
        <p>{`ID: ${order.id}`}</p>
        <p>{`Intento de Pago: ${order.stripePaymentIntentID}`}</p>
        <p>{`Pedido el: ${formatDateTime(order.createdAt)}`}</p>
      ...
      <div className={classes.order}>
        <h4 className={classes.orderItems}>Artículos</h4>
              ...
              <Fragment key={index}>
                <div className={classes.row}>
                  <Link href={`/products/${product.slug}`} className={classes.mediaWrapper}>
                    {!metaImage && <span className={classes.placeholder}>Sin imagen</span>}
